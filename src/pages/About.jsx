    ...
    <div className="legal-page">
      <div className="legal-container">
        ...
        <section>
          <h2>Our Story</h2>
          <p>
            MyTreatmentPath was created by a cancer patient who got tired of drowning in
            spreadsheets, PDFs, and scattered medical records.
          </p>
          <p>
        ...
        <section>
          ...
          <ul>
            <li>The oncologists and integrative medicine clinicians who take patient research seriously</li>
            <li>The cancer community on Reddit, Facebook groups, and patient forums</li>
