...
export default defineConfig({
  ...
  projects: [
    {
      name: 'api-tests',
      testMatch: ['**/api.spec.js', '**/fhir.spec.js', '**/fhir-auth-contracts.spec.js', '**/fhir-security.spec.js', '**/fhir-sync-lifecycle.spec.js', '**/fhir-refresh-contracts.spec.js', '**/fhir-refresh-retry-enhanced.spec.js', '**/portal-sync.spec.js', '**/portal-sync-enhanced.spec.js', '**/portal-ingestion-contracts.spec.js', '**/genomics.spec.js', '**/api-extended.spec.js', '**/api-crud.spec.js', '**/api-coverage.spec.js', '**/medications-extended.spec.js', '**/organ-health-nutrition.spec.js', '**/api-crud-extended.spec.js', '**/subscriptions.spec.js', '**/core-health-crud.spec.js', '**/analytics.spec.js', '**/nutrition-extended.spec.js', '**/cancer-profiles.spec.js', '**/clinical-data-crud.spec.js', '**/genomics-extended.spec.js', '**/data-quality-contracts.spec.js', '**/auth-contracts.spec.js', '**/fhir-token-lifecycle.spec.js', '**/therapy-suggestions.spec.js', '**/auth-check-contracts.spec.js', '**/fhir-oauth-state.spec.js', '**/fhir-portal-seams.spec.js'], 
