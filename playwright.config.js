...
export default defineConfig({
  ...
  projects: [
    {
      name: 'api-tests',
      testMatch: ['**/api.spec.js', '**/fhir.spec.js', '**/portal-sync.spec.js', '**/genomics.spec.js', '**/api-extended.spec.js', '**/api-crud.spec.js', '**/api-coverage.spec.js', '**/medications-extended.spec.js'],
